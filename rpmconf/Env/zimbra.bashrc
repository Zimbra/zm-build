...
PATH=${ZIMBRA_HOME}/bin:${ZIMBRA_HOME}/zimbramon:${ZIMBRA_HOME}/postfix/sbin:${ZIMBRA_HOME}/openldap/bin:${ZIMBRA_HOME}/snmp/bin:${ZIMBRA_HOME}/bdb/bin:${ZIMBRA_HOME}/openssl/bin:${JAVA_HOME}/bin:${PATH}
export PATH
