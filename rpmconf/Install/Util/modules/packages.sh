...
checkPackages() {
	...
	if [ $PLATFORM = "DEBIAN3.1" -o $PLATFORM = "MANDRIVA2006" -o $PLATFORM = "UBUNTU6" -o $PLATFORM = "UBUNTU6_64" -o $PLATFORM = "UBUNTU7" -o $PLATFORM = "DEBIAN4.0" -o $PLATFORM = "DEBIAN4.0_64" ]; then
		LOCALPROC=$PROC
	else
		LOCALPROC=`uname -i`
	fi
