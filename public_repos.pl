@ENTRIES = (
   ...
   { name => "junixsocket",                         branch => "junixsocket-parent-2.0.4",  user => undef    },
   { name => "nekohtml-1.9.13",                     branch => "dev",             user => "zimbra" },
   { name => "zimbra-package-stub",                 branch => "master",          user => undef    },
   ...
   { name => "zm-migration-tools",                  branch => "master",          user => "zimbra" },
