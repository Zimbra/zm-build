...
#-------------------- Get wars content (service.war, zimbra.war and zimbraAdmin.war) ---------------------------
    ...
    then
      ...
      mkdir -p ${repoDir}/zm-build/${currentPackage}/opt/zimbra/lib/ext-common
      cp -f ${repoDir}/zm-zcs-lib/build/dist/bcpkix-jdk15to18-1.78.1.jar ${repoDir}/zm-build/${currentPackage}/opt/zimbra/lib/ext-common/
      cp -f ${repoDir}/zm-zcs-lib/build/dist/bcmail-jdk15to18-1.78.1.jar ${repoDir}/zm-build/${currentPackage}/opt/zimbra/lib/ext-common/
      cp -f ${repoDir}/zm-zcs-lib/build/dist/bcprov-jdk15to18-1.78.1.jar ${repoDir}/zm-build/${currentPackage}/opt/zimbra/lib/ext-common/
      cp -f ${repoDir}/zm-zcs-lib/build/dist/bcutil-jdk15to18-1.78.1.jar ${repoDir}/zm-build/${currentPackage}/opt/zimbra/lib/ext-common/
