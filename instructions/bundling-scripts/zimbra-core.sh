...
main()
{
   ...
   Copy ${repoDir}/zm-db-conf/src/db/migration/migrate20200219-MobileDevices.pl                     ${repoDir}/zm-build/${currentPackage}/opt/zimbra/libexec/scripts/migrate20200219-MobileDevices.pl
