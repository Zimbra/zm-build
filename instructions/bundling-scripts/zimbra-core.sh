...
main()
{
   ...
   Copy ${repoDir}/junixsocket/junixsocket-native/build/libjunixsocket-native-*.nodeps.so       ${repoDir}/zm-build/${currentPackage}/opt/zimbra/lib/
   Copy ${repoDir}/junixsocket/junixsocket-native/build/libjunixsocket-native-*.so              ${repoDir}/zm-build/${currentPackage}/opt/zimbra/lib/
