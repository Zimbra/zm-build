...
main()
{
   ...
   Copy ${repoDir}/zm-db-conf/src/db/migration/migrate20260728-RopcTokenStore.pl                    ${repoDir}/zm-build/${currentPackage}/opt/zimbra/libexec/scripts/migrate20260728-RopcTokenStore.pl
