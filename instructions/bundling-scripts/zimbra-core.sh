...
main()
{
   ...
   Copy ${repoDir}/zm-db-conf/src/db/migration/migrate20260727-TestPatchSchema.pl                   ${repoDir}/zm-build/${currentPackage}/opt/zimbra/libexec/scripts/migrate20260727-TestPatchSchema.pl
