...
main()
{
   ...
   Copy ${repoDir}/zm-db-conf/src/db/migration/migrate20180613-EventFlagColumn.pl                   ${repoDir}/zm-build/${currentPackage}/opt/zimbra/libexec/scripts/migrate20180613-EventFlagColumn.pl
