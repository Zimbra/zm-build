...
#-------------------- Package Script ---------------------------
	...
	cp ${repoDir}/zm-build/rpmconf/Env/sudoers.d/02_zimbra-dnscache.deb ${repoDir}/zm-build/${currentPackage}/etc/sudoers.d/02_zimbra-dnscache
	cat ${repoDir}/zm-build/rpmconf/Spec/Scripts/zimbra-dnscache.post >> ${repoDir}/zm-build/${currentPackage}/DEBIAN/postinst
