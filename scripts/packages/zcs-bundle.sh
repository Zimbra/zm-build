...
cp -f ${repoDir}/zm-licenses/zimbra/zimbra_network_eula.txt                             zcs-${buildType}-${release}_${buildNo}.${os}.${buildTimeStamp}/docs/zimbra_network_eula.txt
cp -f ${repoDir}/zm-licenses/thirdparty/keyview_eula.txt                                zcs-${buildType}-${release}_${buildNo}.${os}.${buildTimeStamp}/docs/keyview_eula.txt
cp -f ${repoDir}/zm-licenses/thirdparty/oracle_jdk_eula.txt                             zcs-${buildType}-${release}_${buildNo}.${os}.${buildTimeStamp}/docs/oracle_jdk_eula.txt
...
cp -f ${repoDir}/zm-build/rpmconf/Install/Util/*sh                                      zcs-${buildType}-${release}_${buildNo}.${os}.${buildTimeStamp}/util
cp -f ${repoDir}/zm-build/rpmconf/Install/Util/modules/*                                zcs-${buildType}-${release}_${buildNo}.${os}.${buildTimeStamp}/util/modules
...
cp -f ${repoDir}/zm-network-build/rpmconf/Install/Util/modules/*                        zcs-${buildType}-${release}_${buildNo}.${os}.${buildTimeStamp}/util/modules
